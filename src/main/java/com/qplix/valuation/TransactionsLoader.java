...
public class TransactionsLoader {
     ...
     */
    private Map<String, NavigableMap<LocalDate, BigDecimal>> transactions = Collections.emptyMap();
    ...
    public void load(String fileName) {
        ...
        Map<String, NavigableMap<LocalDate, BigDecimal>> newTransactions = new HashMap<>();
    ...
    public BigDecimal getValue(String investmentId, LocalDate date) {
        NavigableMap<LocalDate, BigDecimal> transactionsForInvestment = transactions.get(investmentId);
    ...
    private void addTransaction(String investmentId, LocalDate date, BigDecimal value,
                                Map<String, NavigableMap<LocalDate, BigDecimal>> newTransactions) {
